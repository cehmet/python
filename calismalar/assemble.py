    ...
    for i in tok_list:
        if i == 'load':
            ...
            if i == 'cmp':
                ...
                dosya.write( '\tmov dx , [%s]\n'%(symbol_table[tok_list[index+1]]))
            elif i == 'hlt':
                dosya.write( "\tret\n")

        index = index + 1
    dosya.close()
main("C:/Users/ahmet/Desktop/test/aradort.txt", "C:/Users/ahmet/Desktop/test/dortasamble.txt")
main("C:/Users/ahmet/Desktop/test/arafaktor.txt", "C:/Users/ahmet/Desktop/test/faktorasamble.txt")
main("C:/Users/ahmet/Desktop/test/araicice.txt", "C:/Users/ahmet/Desktop/test/iciceasamble.txt") 
main("C:/Users/ahmet/Desktop/test/ararepeatif.txt", "C:/Users/ahmet/Desktop/test/repeatifasamble.txt")
